...
export function PaperHeader({ title, authors, abstract }: PaperHeaderProps) {
  return (
    <header className="py-12 px-4 md:py-16 md:px-6 bg-white dark:bg-gray-950 border-b border-gray-100 dark:border-gray-800">
      <h1 className="text-4xl md:text-5xl font-serif font-bold tracking-normal text-gray-900 dark:text-gray-100">{title}</h1>
      <p className="text-xl md:text-2xl font-sans text-gray-600 dark:text-gray-400 mt-4">{authors.join(', ')}</p>
      <div className="mt-8 md:mt-12 max-w-2xl">
        <h2 className="text-lg font-sans uppercase font-semibold tracking-widest text-accent">Master's dissertation</h2>
